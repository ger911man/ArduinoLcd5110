#ifndef _ADAFRUIT_GFX_EXTENDED_H
#define _ADAFRUIT_GFX_EXTENDED_H
...
class Adafruit_GFX_extended : public Print {

 public:

  Adafruit_GFX_extended(int16_t w, int16_t h); // Constructor
...
class Adafruit_GFX_Button {
 ...
 public:
  ...
  void initButton(Adafruit_GFX_extended *gfx, int16_t x, int16_t y,
  ...
  void initButtonUL(Adafruit_GFX_extended *gfx, int16_t x1, int16_t y1,
   uint16_t w, uint16_t h, uint16_t outline, uint16_t fill,
   uint16_t textcolor, char *label, uint8_t textsize);
  void initButtonUL(Adafruit_GFX_extended *gfx, int16_t x1, int16_t y1,
   uint16_t w, uint16_t h, uint16_t outline, uint16_t fill,
...
class GFXcanvas1 : public Adafruit_GFX_extended {
 public:
...
class GFXcanvas8 : public Adafruit_GFX_extended {
 public:
...
class GFXcanvas16 : public Adafruit_GFX_extended {
 public:
