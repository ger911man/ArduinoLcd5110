...
*********************************************************************/
#ifndef _ADAFRUIT_PCD8544_EXTENDED_H
#define _ADAFRUIT_PCD8544_EXTENDED_H
...
class Adafruit_PCD8544_extended : public Adafruit_GFX_extended {
 public:
  // Software SPI with explicit CS pin.
  Adafruit_PCD8544_extended(int8_t SCLK, int8_t DIN, int8_t DC, int8_t CS, int8_t RST);
  // Software SPI with CS tied to ground.  Saves a pin but other pins can't be shared with other hardware.
  Adafruit_PCD8544_extended(int8_t SCLK, int8_t DIN, int8_t DC, int8_t RST);
  ...
  Adafruit_PCD8544_extended(int8_t DC, int8_t CS, int8_t RST);
